...
function MaterialDropZone(props) {
    ...
    const onDrop = useCallback((filesVal) => {
        ...
        if (oldFiles.length > filesLimit) {
            ...
            setFiles(oldFiles);
            props.handleFileSelectionChange(oldFiles);
        }
    }, [files, filesLimit]);
                ...
                <div key={index.toString()}>
                    <div className="imageContainer col fileIconImg">
                        <figure className="imgWrap">
                            <img className="smallPreviewImg" src={base64Img} alt="preview"/>
                        </figure>
        ...
        <div>
            ...
            >
                {({getRootProps, getInputProps}) => (
                    <div {...getRootProps()} className={classNames(classes.dropItem, classes.dropZone)}>
